...
img_path = "./data2/Image"
mask_path = './data2/Mask'
clean_path_img = './data2/Clean/Image'
clean_path_mask = './data2/Clean/Mask'
meta_path = './data2/Meta/'
print(img_path)
if not os.path.exists(img_path):
    os.makedirs(img_path)
if not os.path.exists(mask_path):
    os.makedirs(mask_path)
if not os.path.exists(clean_path_img):
    os.makedirs(clean_path_img)
if not os.path.exists(clean_path_mask):
    os.makedirs(clean_path_mask)
            ...
            if 1==1:
                ...
                # This current for loop iterates over total number of nodules in a single patient
                    ...
                    for nodule_slice in range(mask.shape[2]):
                        ...
                        if lung_segmented_np_array.shape != (1,512,512) or mask[:,:,nodule_slice].shape!= (1,512,512):
                            continue
                        else:print("save result")
                ...
                for slice in range(vol.shape[2]):
                    ...
                    self.save_meta(meta_list)
                    if not os.path.exists(patient_clean_dir_image / nodule_name):
                        continue
